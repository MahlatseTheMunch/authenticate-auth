class LeavesController < ApplicationController
  ...
  private
    ...
    def leafe_params
      params.require(:leafe).permit(:from_date, :to_date, :from_half, :to_half, :total_days, :description, :leave_type_id, :employee_id, :leave_status_id, :allocation_type_id, :comment)
    end
end
