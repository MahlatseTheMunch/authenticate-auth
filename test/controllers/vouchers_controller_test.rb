...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference("Voucher.count") do
      post vouchers_url, params: { voucher: { comment: @voucher.comment, description: @voucher.description, employee_id: @voucher.employee_id, processed: @voucher.processed } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { comment: @voucher.comment, description: @voucher.description, employee_id: @voucher.employee_id, processed: @voucher.processed } }
