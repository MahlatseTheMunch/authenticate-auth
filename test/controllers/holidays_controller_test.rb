...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference("Holiday.count") do
      post holidays_url, params: { holiday: { holiday_date: @holiday.holiday_date, holiday_name: @holiday.holiday_name, region_id: @holiday.region_id } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { holiday_date: @holiday.holiday_date, holiday_name: @holiday.holiday_name, region_id: @holiday.region_id } }
