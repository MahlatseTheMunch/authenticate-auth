...
class CategoryValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_value" do
    assert_difference("CategoryValue.count") do
      post category_values_url, params: { category_value: { category_id: @category_value.category_id, skhokho_id: @category_value.skhokho_id, value_id: @category_value.value_id } }
    end
  ...
  test "should update category_value" do
    patch category_value_url(@category_value), params: { category_value: { category_id: @category_value.category_id, skhokho_id: @category_value.skhokho_id, value_id: @category_value.value_id } }
